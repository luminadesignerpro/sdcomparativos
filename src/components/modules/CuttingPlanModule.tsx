  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-[#121418] border border-amber-500/30 p-4 sm:p-5 rounded-3xl shadow-xl space-y-4">
        {/* CABEÇALHO DO VISUALIZADOR COM SELETORES E MODOS */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-white/10">
          ...
          {/* Controles de Chapa e Modos de Interação */}
        ...
        {currentActiveSheet ? (
          <div className="space-y-3">
            <div className="bg-[#0b0d11] border border-white/15 rounded-2xl p-3 sm:p-4 space-y-3.5 overflow-x-auto">
              
              {/* ─── BARRA DE FERRAMENTAS PADRONIZADA (1ª IMAGEM DENTRO DA 2ª) ─── */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 pb-2 border-b border-white/10">
                {/* 1. SELETOR DE UNIDADE: MM, CM, MT */}
                <div className="bg-[#101216] border border-amber-500/40 p-1 rounded-xl flex items-center justify-around shadow-md h-10">
                  {(['mm', 'cm', 'm'] as DimensionUnit[]).map((u) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-1 rounded-lg text-xs font-black transition-all flex-1 text-center ${
                          isSelected
                            ? 'bg-amber-500 text-black shadow-md'
                            : 'text-gray-400 hover:text-white hover:bg-white/5'
                        }`}
                ...
                <button
                  ...
                  className="h-10 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black px-3 rounded-xl text-xs flex items-center justify-center gap-1.5 shadow-md transition-all hover:scale-[1.02] border border-emerald-400/30"
                ...
                <button
                  ...
                  className="h-10 bg-white/5 hover:bg-white/10 text-gray-200 hover:text-white border border-white/10 px-3 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-sm"
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full h-10 bg-emerald-600 hover:bg-emerald-500 text-white font-black px-2.5 rounded-xl text-xs flex items-center justify-center gap-1 shadow-md transition-all hover:scale-[1.02] border border-emerald-400/40"
                    title="Enviar PDF do Plano de Corte diretamente pelo WhatsApp"
                  >
                    <MessageCircle className="w-3.5 h-3.5 shrink-0" />
                    <span className="truncate">WhatsApp (PDF)</span>
                    <ChevronDown className={`w-3 h-3 shrink-0 transition-transform ${showWhatsAppModal ? 'rotate-180' : ''}`} />
                  </button>

                  {showWhatsAppModal && (
                    <div className="absolute left-0 sm:right-0 sm:left-auto top-full mt-2 w-80 sm:w-96 bg-[#161821] border-2 border-emerald-400/80 rounded-2xl shadow-2xl p-4 z-[9999] text-white space-y-3.5 animate-in fade-in zoom-in-95">
                ...
                <button
                  ...
                  className="h-10 bg-purple-600 hover:bg-purple-500 text-white font-black px-2.5 rounded-xl text-xs flex items-center justify-center gap-1 shadow-md transition-all hover:scale-[1.02]"
                ...
                <button
                  ...
                  className="h-10 bg-amber-500 hover:bg-amber-400 text-black font-black px-2.5 rounded-xl text-xs flex items-center justify-center gap-1 shadow-md transition-all hover:scale-[1.02]"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs font-medium">
                <div className="bg-[#181b22] border border-white/10 px-3 py-2.5 rounded-xl flex items-center justify-between">
